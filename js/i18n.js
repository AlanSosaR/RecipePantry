...
(function () {
    const translations = {
        es: {
            ...
            allergiesTitle: 'Control de Alergias (UK FSA)',
            allergiesSubtitle: 'Guía visual de alérgenos, ejemplos de contaminación y recetas seguras.',
            allergiesTabGuide: 'Guía y Contaminación',
            allergiesTabSafe: 'Recetas Seguras',
            allergiesTabMatrix: 'Matriz Oficial FSA',
            allergiesWhereHides: '¿Dónde se esconde?',
            allergiesCrossContam: 'Riesgos de contaminación cruzada',
            allergiesSafeTitle: 'Encuentra platos 100% seguros',
            allergiesSafeDesc: 'Marca las alergias que debes evitar y te mostraremos únicamente las recetas libres de esos alérgenos.',
            allergiesSafeSelectPlaceholder: 'Selecciona una o más alergias para filtrar...',
            allergiesNoSafeRecipes: 'No encontramos recetas libres de todos los alérgenos seleccionados.',
            allergiesSafeRecipesFound: 'recetas seguras encontradas',
            allergiesPrintMatrix: 'Imprimir Matriz FSA',
            allergiesContains: 'Contiene',
            allergiesFree: 'Libre',
            allergiesLegendContains: 'Contiene alérgeno',
            allergiesLegendFree: 'Libre de alérgeno',
            allergiesSearchPlaceholder: 'Buscar alérgeno o ingrediente...',
            navProfile: 'Mi Perfil',
            navInstallApp: 'Descargar App',
            navHelp: 'Configuración',
            ...
            settingsSubtitle: 'Administra el almacenamiento offline, caché y preferencias de la aplicación.',
            offlineStorageTitle: 'Uso Offline y Almacenamiento',
            offlineStorageDesc: 'Puedes acceder a tus recetas directamente con internet sin necesidad de descargar nada. Si planeas cocinar o viajar sin conexión, puedes descargar todas tus recetas completas a este dispositivo.',
            offlineDownloadFullBtn: 'Descargar todas las recetas para offline',
            offlineClearBtn: 'Liberar espacio local',
            cacheToolsTitle: 'Mantenimiento del Sistema',
            cacheClearBtn: 'Borrar caché y recargar',
            cacheClearDesc: 'Borra los archivos locales en caché del Service Worker y recarga la versión más reciente.',
            prefLangTitle: 'Idioma',
            ...
            authSubtitleRegister: "Únete para guardar tus recetas favoritas.",
            ...
            switchTextLoginPrefix: "¿No tienes cuenta? ",
            switchTextLoginAction: "Regístrate ahora",
            switchTextRegisterPrefix: "¿Ya tienes cuenta? ",
            switchTextRegisterAction: "Ingresa",
            ...
            syncingChanges: "Sincronizando cambios con la nube...",
            allSynced: "¡Todo sincronizado!",
            offlineReady: "✅ ¡Listo! Recetas disponibles offline",
            recipesUpdated: "✅ Recetas actualizadas",
            syncingProgress: "Descargando recetas para uso offline...",

            // ── Recovery ──────────────────────────────────────────────────
            recoveryTitle: "¿Olvidaste tu contraseña?",
            recoverySubtitle: "Introduce tu correo electrónico y te enviaremos un enlace para restablecerla.",
            recoveryBtn: "Enviar enlace",
            recoveryBack: "Volver al inicio de sesión",
            resetTitle: "Restablecer Contraseña",
            resetSubtitle: "Escribe tu nueva contraseña para acceder a tu cuenta.",
            ...
            pantryDescription: 'Guarda tus recetas y conecta con otros profesionales y amigos que comparten tu pasión',
            featOcrTitle: 'Escanea y organiza',
            featOcrDesc: 'Digitaliza tus recetas en papel en segundos',
            featPlanTitle: 'Intercambia con otros',
            featPlanDesc: 'Comparte con amigos y profesionales en la app',
            btnGetStarted: 'Comenzar',
            footerPrivate: 'Privado',
            ...
            instAndroidTitle: 'Pasos para Android',
            instAndroidSubtitle: 'Sigue estos pasos para instalar la aplicación en tu pantalla de inicio.',
            instAndroidStep1Title: '1. Abrir Chrome',
            instAndroidStep1Desc: 'Inicia el navegador Google Chrome en tu dispositivo Android.',
            instAndroidStep2Title: '2. Menú de opciones',
            instAndroidStep2Desc: 'Toca el icono de tres puntos verticales situado en la esquina superior derecha.',
            instAndroidStep3Title: '3. Instalar aplicación',
            instAndroidStep3Desc: 'Selecciona \'Instalar aplicación\' o \'Añadir a pantalla de inicio\' en el menú desplegable.',
            instIosTitle: 'Instala nuestra App',
            instIosSubtitle: 'Sigue estos sencillos pasos en tu iPhone para disfrutar de la mejor experiencia.',
            instIosStep1Title: '1. Abrir Safari',
            instIosStep1Desc: 'Localiza el ícono de la brújula y abre nuestro sitio web.',
            instIosStep2Title: '2. Tocar \'Compartir\'',
            instIosStep2Desc: 'Busca el ícono de compartir en la barra de herramientas inferior.',
            instIosStep3Title: '3. Añadir a Inicio',
            instIosStep3Desc: 'Desliza hacia abajo y selecciona la opción "Añadir a pantalla de inicio".',
            ...
            profileNoChanges: 'No se detectaron cambios en el perfil',
        ...
        en: {
            ...
            navShared: 'Shared',
            navAllergies: 'Allergies',
            allergiesTitle: 'Allergy Control (UK FSA)',
            allergiesSubtitle: 'Visual allergen guide, contamination sources and safe recipe matching.',
            allergiesTabGuide: 'Guide & Contamination',
            allergiesTabSafe: 'Safe Recipes',
            allergiesTabMatrix: 'Official FSA Matrix',
            allergiesWhereHides: 'Where does it hide?',
            allergiesCrossContam: 'Cross-contamination risks',
            allergiesSafeTitle: 'Find 100% safe dishes',
            allergiesSafeDesc: 'Check the allergies to avoid and we will display only recipes free of those allergens.',
            allergiesSafeSelectPlaceholder: 'Select one or more allergies to filter...',
            allergiesNoSafeRecipes: 'No recipes found free from all selected allergens.',
            allergiesSafeRecipesFound: 'safe recipes found',
            allergiesPrintMatrix: 'Print FSA Matrix',
            allergiesContains: 'Contains',
            allergiesFree: 'Free',
            allergiesLegendContains: 'Contains allergen',
            allergiesLegendFree: 'Allergen-free',
            allergiesSearchPlaceholder: 'Search allergen or ingredient...',
            ...
            settingsSubtitle: 'Manage offline storage, cache and app preferences.',
            offlineStorageTitle: 'Offline Usage & Storage',
            offlineStorageDesc: 'You can access your recipes with internet without downloading anything. If you plan to cook or travel offline, you can download all your recipes to this device.',
            offlineDownloadFullBtn: 'Download all recipes for offline use',
            offlineClearBtn: 'Free up local space',
            cacheToolsTitle: 'System Maintenance',
            cacheClearBtn: 'Clear cache & reload',
            cacheClearDesc: 'Clears cached files from the Service Worker and reloads the latest version.',
            ...
            authSubtitleRegister: "Join to save your favorite recipes.",
            lblName: "Full Name",
            lblEmail: "Email",
            ...
            switchTextLoginPrefix: "Don't have an account? ",
            switchTextLoginAction: "Sign up now",
            switchTextRegisterPrefix: "Already have an account? ",
            switchTextRegisterAction: "Log in",
            ...
            syncingChanges: "Syncing changes with the cloud...",
            allSynced: "All synced!",
            offlineReady: "✅ Ready! Recipes available offline",
            recipesUpdated: "✅ Recipes updated",
            syncingProgress: "Downloading recipes for offline use...",

            // ── Recovery ──────────────────────────────────────────────────
            recoveryTitle: "Forgot your password?",
            recoverySubtitle: "Enter your email address and we'll send you a reset link.",
            recoveryBtn: "Send link",
            recoveryBack: "Back to login",
            resetTitle: "Reset Password",
            resetSubtitle: "Enter your new password to access your account.",
            ...
            pantryDescription: 'Save your recipes and connect with other professionals and friends who share your passion',
            featOcrTitle: 'Scan and organize',
            featOcrDesc: 'Digitize your paper recipes in seconds',
            featPlanTitle: 'Trade with others',
            featPlanDesc: 'Share with friends and professionals in the app',
            ...
            instAndroidTitle: 'Steps for Android',
            instAndroidSubtitle: 'Follow these steps to install the application on your home screen.',
            instAndroidStep1Title: '1. Open Chrome',
            instAndroidStep1Desc: 'Launch the Google Chrome browser on your Android device.',
            instAndroidStep2Title: '2. Options Menu',
            instAndroidStep2Desc: 'Tap the three vertical dots icon located in the top right corner.',
            instAndroidStep3Title: '3. Install App',
            instAndroidStep3Desc: 'Select \'Install app\' or \'Add to Home screen\' from the drop-down menu.',
            instIosTitle: 'Install our App',
            instIosSubtitle: 'Follow these simple steps on your iPhone to enjoy the best experience.',
            instIosStep1Title: '1. Open Safari',
            instIosStep1Desc: 'Locate the compass icon and open our website.',
            instIosStep2Title: '2. Tap \'Share\'',
            instIosStep2Desc: 'Look for the share icon in the bottom toolbar.',
            instIosStep3Title: '3. Add to Home Screen',
            instIosStep3Desc: 'Swipe down and select the "Add to Home Screen" option.',
