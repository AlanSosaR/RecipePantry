// Lógica específica del Dashboard - v456
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('%c🚀 Dashboard Inicializado (Recipe Pantry Premium v456)', 'color: #10B981; font-weight: bold; font-size: 14px;');
