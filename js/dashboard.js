// js/dashboard.js
// Lógica específica del Dashboard - v162
console.log('📄 [File] js/dashboard.js loaded (v162)');
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('%c🚀 Dashboard Inicializado (Recipe Pantry Premium v162)', 'color: #10B981; font-weight: bold; font-size: 14px;');
