// js/dashboard.js
// Lógica específica del Dashboard - v156
console.log('📄 [File] js/dashboard.js loaded (v156)');
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('🚀 Dashboard Inicializado (Recipe Pantry Premium v156)');
