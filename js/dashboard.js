// js/dashboard.js
// Lógica específica del Dashboard - v158
console.log('📄 [File] js/dashboard.js loaded (v158)');
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('🚀 Dashboard Inicializado (Recipe Pantry Premium v158)');
