// js/dashboard.js
// Lógica específica del Dashboard - v159
console.log('📄 [File] js/dashboard.js loaded (v159)');
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('🚀 Dashboard Inicializado (Recipe Pantry Premium v159)');
