// js/dashboard.js
// Lógica específica del Dashboard - v164
console.log('📄 [File] js/dashboard.js loaded (v164)');
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('%c🚀 Dashboard Inicializado (Recipe Pantry Premium v164)', 'color: #10B981; font-weight: bold; font-size: 14px;');
