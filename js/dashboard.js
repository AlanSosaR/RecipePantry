// js/dashboard.js
// Lógica específica del Dashboard - v149
console.log('📄 [File] js/dashboard.js loaded (v149)');
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('🚀 Dashboard Inicializado (Recipe Pantry Premium v149)');
