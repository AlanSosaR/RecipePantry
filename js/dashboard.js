// js/dashboard.js
// Lógica específica del Dashboard - v130
console.log('📄 [File] js/dashboard.js loaded (v130)');
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('🚀 Dashboard Inicializado (Recipe Pantry Premium v130)');
