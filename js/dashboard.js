// js/dashboard.js
// Lógica específica del Dashboard - v157
console.log('📄 [File] js/dashboard.js loaded (v157)');
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('🚀 Dashboard Inicializado (Recipe Pantry Premium v157)');
