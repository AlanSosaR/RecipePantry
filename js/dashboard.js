// js/dashboard.js
// Lógica específica del Dashboard - v135
console.log('📄 [File] js/dashboard.js loaded (v135)');
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('🚀 Dashboard Inicializado (Recipe Pantry Premium v135)');
