// Lógica específica del Dashboard - v455
console.log('📄 [File] js/dashboard.js loaded (v455)');
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('%c🚀 Dashboard Inicializado (Recipe Pantry Premium v455)', 'color: #10B981; font-weight: bold; font-size: 14px;');
