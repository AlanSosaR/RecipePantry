// js/dashboard.js
// Lógica específica del Dashboard - v163
console.log('📄 [File] js/dashboard.js loaded (v163)');
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('%c🚀 Dashboard Inicializado (Recipe Pantry Premium v163)', 'color: #10B981; font-weight: bold; font-size: 14px;');
