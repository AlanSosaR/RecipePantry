// Lógica específica del Dashboard - v458
...
class DashboardManager {
    ...
    async init() {
        try {
            console.log('%c🚀 Dashboard Inicializado (Recipe Pantry Premium v457)', 'color: #10B981; font-weight: bold; font-size: 14px;');
