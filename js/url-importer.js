...
import { extractFromYouTube } from './services/youtube-extractor.js?v=498';
import { extractFromTikTok } from './services/tiktok-extractor.js?v=498';
import { extractFromGoogleDrive } from './services/gdrive-extractor.js?v=498';
import { extractFromDropbox } from './services/dropbox-extractor.js?v=498';
import { structureRecipeFromText } from './services/gemini-recipe-structurer.js?v=498';
import { detectRecipePatterns } from './services/recipe-validator.js?v=498';
