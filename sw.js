/**
 * RecipePantry Service Worker (v481) - PASSIVE
 * Soporte Offline Total + Sync Background
 */

const CACHE_NAME = 'recipe-pantry-v481';
const BUILD_ID = 'v481';
const STATIC_CACHE = 'static-v481';
const DATA_CACHE = 'data-v481';
...
self.addEventListener('install', (event) => {
    self.skipWaiting(); // v481: Forzar actualización inmediata
    event.waitUntil(
...
// 2. Activación: Limpieza y Reclamo (v481)
...
self.addEventListener('fetch', (event) => {
    ...
    // v481: SIEMPRE intentar Red Primero para index.html y ocr.html
