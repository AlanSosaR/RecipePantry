...
const CACHE_NAME = 'recipehub-v260';
const BUILD_ID = '2026-03-13-v260';
...
self.addEventListener('install', (event) => {
    // self.skipWaiting(); // Removido: Dejar que el usuario decida actualizar de forma interactiva (v260+)
    event.waitUntil(
...
self.addEventListener('fetch', (event) => {
    ...
    // v260: Estrategia para JS y CSS: Network First para actualizar de inmediato
