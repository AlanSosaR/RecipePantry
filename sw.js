...
const CACHE_NAME = 'recipehub-v265';
const BUILD_ID = '2026-03-13-v265';
...
self.addEventListener('install', (event) => {
    // self.skipWaiting(); // Removido: Dejar que el usuario decida actualizar de forma interactiva (v265+)
    event.waitUntil(
...
self.addEventListener('fetch', (event) => {
    ...
    // v265: Estrategia para JS y CSS: Network First para actualizar de inmediato
